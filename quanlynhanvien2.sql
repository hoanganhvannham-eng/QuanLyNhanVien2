...
VALUES
(N'Giám đốc', N'Quản lý toàn công ty'),
(N'Trưởng phòng', N'Quản lý phòng ban'),
(N'Nhân viên', N'Thực hiện công việc được giao');
...
VALUES
(1, '2020-01-01', NULL, N'Không xác định thời hạn', 30000000, N'Hợp đồng Giám đốc'),
(2, '2021-03-01', '2026-03-01', N'Xác định thời hạn 5 năm', 20000000, N'Hợp đồng Trưởng phòng'),
(3, '2022-06-15', '2025-06-15', N'Xác định thời hạn 3 năm', 12000000, N'Hợp đồng nhân viên KD'),
(4, '2023-02-01', '2026-02-01', N'Xác định thời hạn 3 năm', 10000000, N'Hợp đồng nhân viên KT');


INSERT INTO tblLuong (MaNV, Thang, Nam, LuongCoBan, SoNgayCong, PhuCap, KhauTru, Ghichu)
VALUES
(1, 7, 2025, 30000000, 22, 5000000, 1000000, N'Lương tháng 7 Giám đốc'),
(2, 7, 2025, 20000000, 22, 3000000, 500000, N'Lương tháng 7 Trưởng phòng'),
(3, 7, 2025, 12000000, 21, 2000000, 200000, N'Lương tháng 7 NV KD'),
(4, 7, 2025, 10000000, 20, 1500000, 100000, N'Lương tháng 7 NV KT');

INSERT INTO tblDuAn (TenDA, MoTa, NgayBatDau, NgayKetThuc, Ghichu)
VALUES
(N'Hệ thống ERP', N'Xây dựng hệ thống quản lý doanh nghiệp', '2023-01-01', '2025-12-31', N'Dự án quan trọng'),
(N'Website TMĐT', N'Phát triển website thương mại điện tử', '2024-03-01', '2025-03-01', N'Dự án thương mại'),
(N'Ứng dụng Mobile', N'Ứng dụng di động bán hàng', '2025-01-01', NULL, N'Dự án mới');

INSERT INTO tblChiTietDuAn (MaNV, MaDA, VaiTro, Ghichu)
VALUES
(1, 1, N'Quản lý dự án', N'Giám sát toàn bộ'),
(2, 1, N'Chủ trì kỹ thuật', N'Thiết kế hệ thống'),
(3, 2, N'Kinh doanh', N'Tìm khách hàng'),
(4, 3, N'Lập trình viên', N'Phát triển ứng dụng');

INSERT INTO tblChamCong (MaNV, Ngay, GioVao, GioVe, Ghichu)
VALUES
(1, '2025-08-01', '08:00:00', '17:00:00', N'Đi làm đúng giờ'),
(2, '2025-08-01', '08:15:00', '17:30:00', N'Đi muộn 15 phút'),
(3, '2025-08-01', '08:00:00', '17:00:00', N'Làm việc đầy đủ'),
(4, '2025-08-01', '08:30:00', '17:00:00', N'Đi muộn 30 phút');

INSERT INTO tblTaiKhoan (MaNV, TenDangNhap, MatKhau, Quyen, Ghichu)
VALUES
(1, 'admin', '123456', N'Admin', N'Tài khoản quản trị'),
(2, 'thib', '123456', N'Manager', N'Tài khoản trưởng phòng'),
(3, 'vanc', '123456', N'User', N'Tài khoản nhân viên KD'),
(4, 'thid', '123456', N'User', N'Tài khoản nhân viên KT');
